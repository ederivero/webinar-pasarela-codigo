...
exports.getPending = exports.getFailure = exports.getSuccess = exports.postCrearPreferenceMercadoPago = void 0;

var _nodeFetch = _interopRequireDefault(require("node-fetch"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const postCrearPreferenceMercadoPago = async (req, res) => {
  ...
  const peticion = await (0, _nodeFetch.default)(`https://api.mercadopago.com/checkout/preferences`, {
    method: "POST",
    headers: {
...
exports.postCrearPreferenceMercadoPago = postCrearPreferenceMercadoPago;
